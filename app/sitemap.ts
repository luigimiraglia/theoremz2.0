...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticEntries: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/calcolatori`, changeFrequency: "weekly", priority: 0.8 },
    { url: `${baseUrl}/calcolatori/calcolo-percentuale`, changeFrequency: "monthly", priority: 0.7 },
    { url: `${baseUrl}/calcolatori/mcd-online`, changeFrequency: "monthly", priority: 0.7 },
    { url: `${baseUrl}/calcolatori/mcm-online`, changeFrequency: "monthly", priority: 0.7 },
    ...
    { url: `${baseUrl}/calcolatori/proporzioni-online`, changeFrequency: "monthly", priority: 0.7 },
    { url: `${baseUrl}/calcolatori/potenze-online`, changeFrequency: "monthly", priority: 0.7 },
    { url: `${baseUrl}/calcolatori/derivate-online`, changeFrequency: "monthly", priority: 0.7 },
    { url: `${baseUrl}/calcolatori/integrali-online`, changeFrequency: "monthly", priority: 0.7 },
    ...
    { url: `${baseUrl}/calcolatori/equazioni-secondo-grado`, changeFrequency: "monthly", priority: 0.7 },
    { url: `${baseUrl}/calcolatori/sistemi-equazioni`, changeFrequency: "monthly", priority: 0.7 },
