...
export const metadata: Metadata = {
  title: "Richiedi una chiamata gratuita | Theoremz",
  description:
    "Un consulente accademico ti contatterà gratuitamente per aiutarti a capire l’opzione migliore per le tue necessità.",
      ...
      <section className="mx-auto max-w-3xl sm:px-6 pb-10 pt-3">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-[15.5px] px-5 sm:text-[16px] text-slate-600 [.dark_&]:text-slate-300">
            Ti contatteremo gratuitamente per aiutarti a scegliere l’opzione più
