...
| `MANYCHAT_OPENAI_VISION_MODEL` | opzionale | Di default usa lo stesso modello testuale (es. `gpt-4o-mini`). Impostalo solo se vuoi forzare un modello vision diverso a cui hai accesso. |
