          ...
          <div className="flex items-center justify-between pb-2">
            ...
            {step === 2 && (
              <button
                ...
                className="text-xs font-semibold text-slate-600 underline underline-offset-4 hover:text-slate-800 dark:text-slate-300 dark:hover:text-white"
              >
                Indietro
              </button>
            )}
                      ...
                      timeSlots.map((slot) => {
                        ...
                        return (
                          <button
                            ...
                            className={`group flex h-full flex-col justify-between rounded-xl border px-3 py-2 text-left transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-slate-200 dark:focus-visible:ring-offset-slate-950 ${
                              disabled
                                ...
                                : isSelected
                                  ? "border-slate-900 bg-slate-900 text-white shadow-sm dark:border-slate-100/30 dark:bg-slate-100/10 dark:text-white"
                                  : "border-slate-200 bg-white hover:border-slate-300 dark:border-slate-800 dark:bg-slate-900/80 dark:text-white dark:hover:border-slate-700"
                            }`}
                          >
                            <div className="flex items-center justify-between">
